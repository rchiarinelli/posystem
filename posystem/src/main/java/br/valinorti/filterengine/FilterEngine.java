	...
	public String parseFilter(Filter filter){
		...
		if (!filter.getArguments().isEmpty()){
			...
			for (FilterArgument arg : filter.getArguments()) {
				if (arg.getCondition()==FilterConditions.EQUALS){
					if (hasArgs){
						query.append("and\t");
					} else {
						hasArgs=true;
					...
					query.append(")\t");
				} else if (arg.getCondition()==FilterConditions.NOT_EQUALS){
					if (hasArgs){
						query.append("and\t");
					} else {
						hasArgs=true;
					...
					query.append(")\t");					
				} else if (arg.getCondition()==FilterConditions.BETWEEN){
					if (hasArgs){
						query.append("and\t");
					} else {
						hasArgs=true;
					...
					query.append("\t");					
				} else if (arg.getCondition()==FilterConditions.IN){
					if (hasArgs){
						query.append("and\t");
					} else {
						hasArgs=true;
					...
					query.append(")\t");					
				} else if (arg.getCondition()==FilterConditions.LIKE){
					if (hasArgs){
						query.append("and\t");
					} else {
						hasArgs=true;
